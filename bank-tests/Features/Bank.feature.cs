...
namespace BankTests.Features
{
    ...
    [TechTalk.SpecRun.FeatureAttribute("Bank", Description="\tSimple bank resgistration check", SourceFile="Features\\Bank.feature", SourceLine=0)]
...
#line hidden
        ...
        [TechTalk.SpecRun.ScenarioAttribute("Registration check", new string[] {
                "mytag"}, SourceLine=4)]
...
#line hidden
#line 8
 testRunner.Then("I can see registration button", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line hidden
            }
